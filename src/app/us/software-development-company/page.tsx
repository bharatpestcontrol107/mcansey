...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Software Development Comapny & Services | MCANSEY",
...
export default function SoftwareDevelopment() {
  return (
    <>
    <AllHome title="  Transforming Ideas into Powerful, Scalable Software"
        subtitle=" Unlock the Full Potential of Your Business with Our Expert Software Solutions"
        videoSrc="/SoftwareDevelopment/mcansey-software-development-video.mp4" />
