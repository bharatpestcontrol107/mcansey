...
export default function ChartSlider() {
  ...
  return (
    <div className="w-full p-10">
        <h2 className="text-2xl md:text-4xl lg:text-6xl text-slate-800 font-bold leading-tight text-left mb-2 mt-0 relative z-2">
              ...
              {modules
                ...
                .map((module, index) => (
                  ...
                  >
                    ...
                    <h2 className="text-xl md:text-2xl xl:text-3xl font-semibold mb-2 py-2 ">{module.title}</h2>
