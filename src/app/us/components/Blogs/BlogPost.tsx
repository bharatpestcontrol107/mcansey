  ...
  return [
    {
      ...
      shortDescription: "Learn about the latest features in React 18 including concurrent rendering, automatic batching, and new APIs.",
      featuredImage: "/Blogs/download.webp",
    ...
    },
    {
      ...
      shortDescription: "Explore modern TypeScript patterns and practices that will help you write better, more maintainable code.",
      featuredImage: "/Blogs/typescript.webp", 
    ...
    },
    {
      ...
      shortDescription: "A comprehensive guide to building production-ready APIs using Node.js, Express, and MongoDB.",
      featuredImage: "/Blogs/nodejs.webp",
    ...
    },
    {
      ...
      shortDescription: "Discover the new features in Next.js 14 and learn how to build modern web applications.",
      featuredImage: "/Blogs/nextjs.webp",
      createdAt: new Date(Date.now() - 259200000).toISOString(), // 3 days ago
      author: "Sarah Wilson",
      slug: "intro-nextjs-14",
      category: "Frontend",
      tags: ["Next.js", "React", "Web Development"]
    },
    {
      title: "CSS Grid Mastery",
      shortDescription: "Master CSS Grid layout with practical examples and advanced techniques for modern web layouts.",
      featuredImage: "/Blogs/css.webp",
    ...
    },
    {
      ...
      shortDescription: "Learn how to use Docker effectively in your development workflow with practical examples.",
      featuredImage: "/Blogs/Docker.svg",
  ...
  return (
    <>
      <div className="relative w-full h-96 mb-6">
        <Image
          src="/Blogs/banner-resources.png"
          alt="Blog Banner"
          ...
          >
            <div className='relative flex items-center sm:items-start'>
              <Input
                ...
                className="flex-grow  md:p-6 text-white "
              />
              <Button
                type="submit"
                className="flex h-full absolute right-0 bg-white hover:bg-white"
                aria-label="search"
              >
                <Search className="h-6 w-4 mr-1 text-black" />
              </Button>
            </div>
          </form>
        </div>
      ...
      <div className="max-w-7xl mx-auto mb-6">
        <div className="px-5">
          <div className='flex flex-col-reverse md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0 md:mb-8'>
            <h2 className='text-xl sm:text-2xl md:text-3xl font-semibold mt-4 md:mt-0'>
              Our Blog
            </h2>
