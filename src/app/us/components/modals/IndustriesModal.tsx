...
const categories: Category[] = [
  { icon: <FaHeartbeat />, name: "Healthcare", link:"/us/healthcare-software-development-services" },
  { icon: <MdOutlineRealEstateAgent />, name: "Real Estate" ,link:"/us/real-estate-software-development-services" },
  { icon: <FaWallet />, name: "Banking", link:"/us/banking-it-services" },
  { icon: <IoBusinessSharp />, name: "Fintech" , link:"/us/fintech-software-development"},
  { icon: <SiBmcsoftware />, name: "Software & Technology" , link:"/us/software-development-services" },
 
 
  { icon: <MdEmojiTransportation />, name: "Travel & Transportation" ,link:"/us/travel-application-development-services" },
  { icon: <GiPublicSpeaker />, name: "Public Sector", link:"/us/it-solutions-for-public-sector" },
  { icon: <IoNewspaper />, name: "Media & Entertainment", link:"/us/media-and-entertainment-software-solutions" },
  { icon: <IoSchool />, name: "Education", link:"/us/education-software-development-services"},
  { icon: <GiOfficeChair />, name: "Industrial & Manufacturing", link:"/us/industrial-and-manufacturing-development-services" },
];
