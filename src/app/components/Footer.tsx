...
import { FaFacebookF, FaLinkedinIn, FaEnvelope, FaInstagram, FaPhoneAlt, FaWhatsapp, FaTelegram } from "react-icons/fa";
import { toast, ToastContainer } from "react-toastify";
import WhatsAppFloat from "./Home/WhatsAppFloat";
import TelegramFloat from "./Home/TelegramFloat";
...
const Footer: FC = () => {
  ...
  const connectSection = [
    {
      label: "Sales Enquiry",
      icon: FaPhoneAlt,
      details: "+91 9878362625, +91 8968617335",
    },
    {
      label: "HR Enquiry",
      icon: FaPhoneAlt,
      details: "+91 9501764674",
    },
    {
      label: "Email",
      icon: FaEnvelope,
      details: "info@antiersolutions.com",
      href: "mailto:info@antiersolutions.com",
    },
  ];
  ...
  return (
    <footer className="bg-gray-900 text-white py-8 relative tracking-wider [word-spacing:0.21rem]  ">
      <div className="container mx-auto px-4 xl:w-[85%]">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 xl:gap-3 2xl:grid-cols-6 gap-6 md:gap-8 lg:gap-12 text-center sm:text-left">
          ...
          <div className="sm:col-span-1 lg:col-span-auto tracking-wider">
            <h2 className="text-lg font-semibold mb-4 text-center sm:text-left">Connect</h2>
            <ul className="space-y-6">
              {/* Sales Enquiry */}
              <li>
                <h3 className="text-sm font-semibold mb-2 text-center sm:text-left">Sales Enquiry</h3>
              ...
              {/* Email */}
              <li>
                <h3 className="text-sm font-semibold mb-2 text-center sm:text-left">Email</h3>
                <div className="flex flex-col sm:flex-row items-center sm:items-start sm:space-x-2 text-sm">
        ...
        <div className="mt-8 flex flex-col md:flex-row justify-between items-center border-t border-gray-700 pt-4">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-2 md:gap-4 text-sm">
            {footerBottomLinks.map(({ name, href }, index) => (
              <Link
                key={index}
                href={href}
