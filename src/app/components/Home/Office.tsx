...
const offices: Office[] = [
  { 
    country: 'HQ INDIA', 
    address: ['5th floor, Technopolis Knowledge Park,', 'Chakala, Hanuman Nagar, Andheri East,', 'Mumbai, Maharashtra 400093'], 
    image: hqIndiaImage, 
  ...
  { 
    country: 'INDIA', 
    address: [ '359, Sector -28,', 'Gurgaon -122001, ','Haryana India'], 
    image: indiaImage ,
    flag: "/Footer/india.png",
    phone: '+91 9323170652',
  },
  { 
    ...
    image: usaImage ,
    flag: "/Footer/USAflag.jpg",
    phone: '+1 4122735579',
  },
  { 
    country: 'HONG KONG', 
    address: [ 'Suite 1108, 11th Floor, Ocean Centre', '5 Canton Road Harbour City, Kowloon', 'Hong Kong'], 
    image: hongKongImage,
    flag: "/Footer/download.png",
    phone: '+852 21550800',
  },
];
