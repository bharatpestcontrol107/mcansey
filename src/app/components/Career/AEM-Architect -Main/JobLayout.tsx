...
const jobs: Job[] = [
  ...
  { title: "React Native Developer", price: " 7 - 12 LPA", location: "Mumbai, India", time: "5 mins ago", image: logo, link:"/jobs/aem-developer" },
...
const employmentInfo = [
  {
    ...
    label: "Industry:",
    value: "AEM (Adobe Experience Manager) Architect "
  },
  {
    icon: <FaBriefcase className="mr-2 text-blue-600 text-2xl" />,
    label: "Job Level:",
          ...
          <div className="border rounded-lg shadow-sm p-4 mb-4 bg-white mx-auto">
            <div className="flex flex-col sm:flex-row items-center mb-4">
              ...
              <div className="mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
                ...
                <Link href="#" className="text-blue-500 text-[12px] hover:underline ">Open Jobs</Link>
              </div>
            </div>
