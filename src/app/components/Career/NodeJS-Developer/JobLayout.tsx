...
// import React from 'react';
// import { FaBuilding, FaDollarSign, FaBriefcase, FaClock, FaLinkedin, FaTwitter } from 'react-icons/fa';
// import exampleLogo from '../../../../../public/Home/Mcansey 100X100 L.png';
// import exampleJobImage from '../../../../../public/Home/Mcansey 100X100 L.png';
// import JobLayout from '../common/JobLayout';
...
//   const employmentInfo = [
//     { icon: <FaDollarSign />, label: 'Salary:', value: '$80k - $100k' },
//     { icon: <FaBriefcase />, label: 'Job Type:', value: 'Full-Time' },
//     { icon: <FaBuilding />, label: 'Department:', value: 'Engineering' },
//     { icon: <FaClock />, label: 'Posted:', value: '2 days ago' },
//   ];

//   const jobDetails = {
//     welcomeMessage: 'Join our team as a Software Engineer!',
//     description:
//       'We are looking for a talented Software Engineer to join our dynamic team. You will be working on exciting projects and cutting-edge technologies.',
//     essentialKnowledge: [
...
//     {
//       name: 'LinkedIn',
//       url: 'https://www.linkedin.com/company/techinnovators',
//       icon: <FaLinkedin />,
