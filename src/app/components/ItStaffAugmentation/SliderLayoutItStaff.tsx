...
import "swiper/css";
import ServiceCardItStaff from "./ServiceCardItStaff";
...
export default function SliderLayoutItStaff({ title, description, cards }: SliderLayoutProps) {
          ...
          >
            {cards.map((card, index) => (
              <SwiperSlide key={index} className="h-auto">
                <ServiceCardItStaff icon={card.icon} title={card.title} description={card.description} />
              </SwiperSlide>
            ))}
          </Swiper>
        </div>
