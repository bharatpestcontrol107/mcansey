...
export default function ShopifyFooter() {
  return (
    <main className="relative  w-full bg-white" id='contact-us'>
       
      <section className="relative z-10 mx-auto max-w-7xl px-4 pt-4 lg:pt-16 sm:px-6 lg:px-8 xl:max-w-[80%] ">
      
        <div className="relative overflow-hidden rounded-xl bg-white shadow-xl border">
          <div className="grid lg:grid-cols-10">
            {/* Left Column */}
            <div className="bg-black px-6 py-10 sm:px-10 lg:col-span-3">
