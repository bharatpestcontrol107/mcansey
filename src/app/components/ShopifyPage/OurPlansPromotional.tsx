...
function PricingCard({ plan, defaultActive }: { plan: PricingPlan; defaultActive?: boolean }) {
  ...
  return (
    <Card
      className={`p-6 rounded-2xl border-b-4 border-black transition-all duration-300 ${isHovered ? "bg-[#00785A] text-white" : "bg-[#fffdf8] text-black"}`}
...
// OurPlans component
export default function OurPlansPromotional() {
  return (
    <section
      className="relative w-full"
      
     id="pricing">
      <div className="relative rounded-xl max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 md:pb-24 pb-8" style={{backgroundSize: "cover", backgroundPosition: "center", }}>
        ...
        <div className="flex justify-center mb-12">
            <div className="space-y-4 text-center">
                ...
                <h2 className={`text-2xl sm:text-3xl lg:text-4xl font-bold tracking-wider text-black    `} style={{fontFamily:'Clash Grotesk', fontWeight:'700'}}>
                   Shopify Plans That Fit For Your Ecommerce Business
                </h2>
            </div>
        </div>
