...
export default function Footer() {
    return (
      <footer className="bg-[black] pt-[20%] -mt-[15%] md:pt-[10%] md:-mt-[7%]">
      <div className="mx-auto max-w-7xl px-4 pb-12 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-1 lg:grid-cols-12">
          {/* Left Section */}
          <div className="lg:col-span-4">
            <div className="mb-4">
              <h2 className={`text-2xl font-bold text-black  ${sora.className}`} >Mcansey</h2>
          ...
          <div className="flex flex-col gap-8 lg:col-span-8 lg:flex-row lg:gap-16">
            ...
            <div className="w-full lg:w-48 tracking-wider" style={{ fontFamily: "Clash Grotesk", fontWeight: "400" }}>
              ...
              <ul className={`space-y-4 text-sm`} style={{ fontFamily: "Clash Grotesk", fontWeight: "400" }}>
                ...
                <li>
                  <Link href="#shopifytest" className="text-gray-300 hover:text-white">
                    Testimonials
                  </Link>
                </li>
                <li>
                  <Link href="#faqshopify" className="text-gray-300 hover:text-white">
                    FAQ
                  </Link>
                </li>
              </ul>
