...
export default function ProductIdeation() {
    return (
        <>
<Navbar/>
<AllHome title={(<> Innovative Mobile Apps <br /> That Drive Success</>)}
        subtitle="Build the Future of Your Business with Our Custom Mobile Apps"
        backgroundImage="/Banners/mcansey-mobile-development-company.webp"
        mobileBackgroundImage="/Banners/mcansey-mobile-app.webp"
        />
