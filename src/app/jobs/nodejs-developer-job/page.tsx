...
import JobCard from "@/app/components/Career/NodeJS-Developer/JobCard";
import JobLayout from "@/app/components/Career/NodeJS-Developer/JobLayout";
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: {
      canonical: 'https://www.mcansey.com/jobs/nodejs-developer/',
      languages: {
        'en-US': 'https://www.mcansey.com/jobs/nodejs-developer/',
      },
    },
    ...
    openGraph: {
      type: 'article',
      locale: 'en_US',
      url: 'https://www.mcansey.com/jobs/nodejs-developer/',
