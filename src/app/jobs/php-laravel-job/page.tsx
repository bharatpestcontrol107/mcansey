...
import JobCard from "@/app/components/Career/Php-Developer/JobCard";
import JobLayout from "@/app/components/Career/Php-Developer/JobLayout";
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    alternates: {
      canonical: 'https://www.mcansey.com/jobs/php-laravel/',
      languages: {
        'en-US': 'https://www.mcansey.com/jobs/php-laravel/',
      },
    },
    ...
    openGraph: {
      type: 'article',
      locale: 'en_US',
      url: 'https://www.mcansey.com/jobs/php-laravel/',
