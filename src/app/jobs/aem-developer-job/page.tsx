...
import JobCard from "@/app/components/Career/descriptionPage/JobCard";
import JobLayout from "@/app/components/Career/descriptionPage/JobLayout";
...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "AEM Developer Jobs | MCANSEY",
    description: " MCANSEY is hiring AEM Developers. Apply for AEM Developer Jobs in Mumbai, India. MCANSEY is a leading IT  company. ",
    keywords: "AEM Developer Jobs, AEM Developer,  ",
    alternates: {
      canonical: 'https://www.mcansey.com/jobs/aem-developer/',
      languages: {
        'en-US': 'https://www.mcansey.com/jobs/aem-developer/',
      },
    },
    ...
    openGraph: {
      type: 'article',
      locale: 'en_US',
      url: 'https://www.mcansey.com/jobs/aem-developer/',
