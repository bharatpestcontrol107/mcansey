...
export default function Development() {
  return (
    <>
    <Navbar/>
    <AllHome title={(<> Website Design <br />& Development Services</>)}
        subtitle={(<> Our website design & development services create visually engaging and high-performance <br /> websites tailored to your business needs. From user-friendly interfaces to seamless  functionality, we ensure your website delivers an exceptional experience for every visitor</>)}
        backgroundImage="/Banners/mcansey-website-design-company.webp"
        mobileBackgroundImage="/Banners/mcansey-website-design.webp" />
      <Homedd />
      <Stat />
      <Technologies />
      <Customsection/>
